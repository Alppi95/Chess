...
public:
	...
	double laskeNappuloidenSijainti(int vari);// Nappuloiden yhteenlaskettu arvo.
	double linnotusPorkkana(int vari);
	double laskeParhaatNappulaPositiot(int vari,bool isMiddleGame);
	//double katsoKunkkuLaheisyys(int vari);
